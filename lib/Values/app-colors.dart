...
class AppColors {
  ...
  static final Color primaryAlphaAccentColor = HexColor.fromHex("55246CFD");
  static final Color primaryAccentColorV2 = HexColor.fromHex("246CFF");
  static final Color pageBgColor = HexColor.fromHex("181a1f");
}
